//#region node_modules/.nitro/vite/services/ssr/assets/geo-utils-Dx58A-zZ.js
var COUNTRY_MAP = {
	US: {
		name: "United States",
		flag: "🇺🇸",
...
function resolveGeoLocation(countryInput, existingFlag, existingCity, existingPostal, existingStreet) {
	...
	if (countryInput && typeof countryInput === "object") {
		targetCountry = typeof countryInput.country === "string" ? countryInput.country : typeof countryInput.country_code === "string" ? countryInput.country_code : typeof countryInput.countryCode === "string" ? countryInput.countryCode : "";
		if (typeof countryInput.flag === "string" && countryInput.flag) targetFlag = countryInput.flag;
		if (typeof countryInput.city === "string" && countryInput.city) targetCity = countryInput.city;
		if (typeof countryInput.postal_code === "string" && countryInput.postal_code) targetPostal = countryInput.postal_code;
		else if (typeof countryInput.postalCode === "string" && countryInput.postalCode) targetPostal = countryInput.postalCode;
		if (typeof countryInput.street === "string" && countryInput.street) targetStreet = countryInput.street;
		if (typeof countryInput.region === "string" && countryInput.region) targetRegion = countryInput.region;
	} else if (typeof countryInput === "string") targetCountry = countryInput;
	else if (countryInput !== null && countryInput !== void 0) targetCountry = String(countryInput);
...
//#endregion
export { resolveGeoLocation as t };
