...
export function LeadsTab({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="surface-lift rounded-2xl bg-card border border-black/8 p-5 sm:p-6 shadow-[0_0_0_1px_rgb(0_0_0_/_0.04)] space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5">
              <span className="p-2 rounded-xl bg-blue/10 text-blue">
                <Users className="size-5" />
              </span>
              <div>
                <h2 className="text-base font-bold text-label font-display tracking-tight">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 pt-2">
          <div className="p-3.5 rounded-xl bg-fill-subtle/60 border border-black/6">
            <span className="text-[11px] text-muted-foreground uppercase font-semibold">Total Leads</span>
          ...
          <div className="p-3.5 rounded-xl bg-fill-subtle/60 border border-black/6">
            <span className="text-[11px] text-muted-foreground uppercase font-semibold">Blog Readers</span>
            <div className="flex items-baseline gap-2 mt-1">
              <span className="text-xl font-bold font-mono text-rose-600">{blogReaderCount}</span>
              <span className="text-[11px] text-muted-foreground">Content Inbound</span>
            </div>
          </div>

          <div className="p-3.5 rounded-xl bg-fill-subtle/60 border border-black/6">
            <span className="text-[11px] text-muted-foreground uppercase font-semibold">Qualified Pipeline</span>
            <div className="flex items-baseline gap-2 mt-1">
              ...
              {filteredLeads.length === 0 ? (
                <tr>
                  <td colSpan={8} className="py-16 text-center text-subtle">
                    <Users className="size-8 mx-auto text-subtle/60 mb-2" />
                ...
                filteredLeads.map((l) => (
                  <tr key={l.id} className="hover:bg-fill-subtle/40 transition-colors">
                    {/* Name & Company */}
